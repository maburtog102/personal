	  ...
	  _createClass(BootstrapTable, [{
	    ...
	    value: function trigger(_name) {
	      ...
	      for (var _len = arguments.length, args = new Array(_len > 1 ? _len - 1 : 0), _key2 = 1; _key2 < _len; _key2++) {
            ...
            var eventFun = (_this$options = this.options)[BootstrapTable.EVENTS[name]];//.apply(_this$options, args);

            if (typeof eventFun === 'string') {
               Utils.calculateObjectValue(this, eventFun, args);
            }
            else {
                eventFun.apply(_this$options, args);
            }
